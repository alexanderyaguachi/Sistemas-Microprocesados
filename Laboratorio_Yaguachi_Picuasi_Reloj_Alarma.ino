...
attachInterrupt(digitalPinToInterrupt(19),bfuncion,FALLING);
attachInterrupt(digitalPinToInterrupt(20),modificar,FALLING);
attachInterrupt(digitalPinToInterrupt(21),aumentar,FALLING);
